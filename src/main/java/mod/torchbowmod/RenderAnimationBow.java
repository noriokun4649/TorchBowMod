...
public class RenderAnimationBow implements IItemRenderer {
	private RenderManager renderManager;
	private Minecraft mc;
	private TextureManager texturemanager;

	public RenderAnimationBow() {
	...
	@Override
	// HandleRenderType lets forge know if it will render the item in the
	// requested view.
	public boolean handleRenderType(ItemStack item, ItemRenderType type) {
		// You can remove everything after "EQUIPPED" if you only want this
		// class to render the third person item.
		return type == ItemRenderType.EQUIPPED || type == ItemRenderType.EQUIPPED_FIRST_PERSON;
	}

	@Override
	// RenderHelpers I don't fully understand, I'd assume they are modifiers,
	...
	@Override
	// This function decides what to do in rendering an item, whether it's first
	// or third person.
